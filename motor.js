...
function prepararMotorLiturgico(anoParaCalcular) {
    ...
    addM(dP(70), {t:"3º Domingo depois de Pentecostes (na Oitava do S. Coração)", rito:RITO.SEMIDUPLEX, prec:PREC.DOMINGO_COMUM, s:"Sl 24. Réspice in me et miserére mei... 1 Pd 5,6-11 • Lc 15,1-10", l:"/", dom:true, p: { cor: COR.VERDE, gloria: true, credo: true, prefacio: PREF.CORACAO }});
